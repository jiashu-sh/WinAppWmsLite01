...
namespace WinAppWmsLite.Common
{
    class Code128
    {
        ...
        //private Font m_ValueFont = new Font("黑体", 14); 
        //new Font("黑体", 12)
        /// <summary>
        ...
        private void GetViewText(Bitmap p_Bitmap, string p_ViewText)
        {
            ...
            _Graphics.DrawString(p_ViewText, m_ValueFont, Brushes.Black, (p_ViewText.Length / 2) + 20, _StarY);
        }
        ...
        /**新版打印128**/
        internal string Get128CodeString_New(string inputData)
        {
            string result;
            int checksum = 104;
            for (int ii = 0; ii < inputData.Length; ii++)
